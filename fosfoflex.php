    ...
    <?php $title = "FOSFOFLEX E 100% | Mediker - Comercializadora Pecuaria de México" ?>
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="productos.php">ANTIBIÓTICOS Y QUIMIOTERÁPICOS</a></li>
                        <li class="breadcrumb-item active" aria-current="page">FOSFOFLEX E 10%</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col_left_pto_descrp">
                    <h1 class="tit_secundario">FOSFOPLEX E 10%</h1>
                    <br>
                    ...
                    <p class="txt_general">
                        ...
                        Cerdos: Síndrome MMA, neumonía enzoótica, rinitis atrófica, colibacilosis, disentería, diarreas inespecíficas.</p>
                    <h6 class="tit_tercero">Fórmular:</h6>
                    <p class="txt_general">
                    ...
                    <p class="txt_general">
                        ...
                        Aves (pollo de engorda y polla de reemplazo): 0.1 ml/kg de peso (equivalente a 10 mg/kg de peso).</p>
                    <h6 class="tit_tercero">Advertencias:</h6>
                    <p class="txt_general">
                        No destinar a consumo humano la carne de los animales tratados hasta 14 días después de la última aplicación. No destinar a la industria y consumo humano la leche de los animales tratados hasta 3 días después de la última aplicación.</p>
