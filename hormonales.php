                    ...
                    <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
                        ...
                        <!-- PRIMERA FILA -->
                            ...
                            <div class="col-12 col-lg-4">
                                <a href="Ovoplex.php?cat=<?php echo $cadena; ?>" class="nom_producto d-block">
                                    <div class="article-loop">
                                        <div class="cont_p_indv">
                                            <img class="mask img-fluid" src="Public/images/ovoplex-mdkr-01.jpg" alt="Mediker Ovoplex" width="130">
                                            <p>Ovoplex</p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-12 col-lg-4">
                                <a href="Oxitoplex.php?cat=<?php echo $cadena; ?>" class="nom_producto d-block">
                                    <div class="article-loop">
                                        <div class="cont_p_indv">
                                            <img class="mask img-fluid" src="Public/images/oxitoplex-01.jpg" alt="Mediker Oxitoplex" width="130">
                                            <p>Oxitoplex</p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-12 col-lg-4">
                                <a href="Prostaplex-D.php?cat=<?php echo $cadena; ?>" class="nom_producto d-block">
                                    <div class="article-loop">
                                        <div class="cont_p_indv">
                                            <img class="mask img-fluid" src="Public/images/prostaplex-d-01.jpg" alt="Mediker Prostaplex-D" width="130">
                                            <p>Prostaplex-D</p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-12 col-lg-4">
                                <a href="Fertiplex.php?cat=<?php echo $cadena; ?>" class="nom_producto d-block">
                                    <div class="article-loop">
                                        <div class="cont_p_indv">
                                            <img class="mask img-fluid" src="Public/images/fertiplex-01.jpg" alt="Mediker Fertiplex" width="130">
                                            <p>Fertiplex</p>
                                        </div>
                                    </div>
                                </a>
